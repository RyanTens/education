  ...
  def getDwsQzChapter(sparkSession: SparkSession, dt: String) = {
    sparkSession.sql(
      s"""
         ...
         |chapterlistid,
         |chaptername,
         |sequence as chapter_sequence,
         |status as chapter_status,
         |chapter_courseid,
         |chapternum,
         |chapterallnum,
         |outchapterid,
  ...
  def getDwsQzPaper(sparkSession: SparkSession, dt: String) = {
    sparkSession.sql(
      s"""
         ...
         |totalscore,
         |dn
         |from dws.dws_qz_paper where dt=$dt
         |""".stripMargin)
  }
  ...
  def getDwsQzQuestion(sparkSession: SparkSession, dt: String) = {
    sparkSession.sql(
      s"""
         ...
         |splitscoretype as question_splitscoretype,
         |dn
